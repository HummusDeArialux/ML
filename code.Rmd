...
for i in k_list:
  ...
  # Error
  error_i = 1 - knn.score(seq_encoded_test, y_test)
  error_list.append(error_i)

tabla2 = [[k_list[0], accuracy_list[0]], [k_list[1], accuracy_list[1]], [k_list[2], accuracy_list[2]], [k_list[3], accuracy_list[3]], [k_list[4], accuracy_list[4]]]
print(tabulate(tabla2, headers=["k", "Accuracy"]))

print("Confusion Matrix:\n", cm_list)
print("Kappa Value:", kappa_list)
print("Classification Error:", error_list)
